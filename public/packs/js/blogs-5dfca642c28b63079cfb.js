...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _channels_consumer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../channels/consumer */ "./app/javascript/channels/consumer.js");
...
jQuery(document).on('turbolinks:load', function() {
  ...
  if (comments.length > 0) {
    _channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    console.log('madarchod1');
    ({
      received: function(data) {
        comments.append(data['comment']);
        return console.log(comments.append(data['comment']));
      },
...
/******/ });
//# sourceMappingURL=blogs-5dfca642c28b63079cfb.js.map
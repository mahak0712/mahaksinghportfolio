...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module '../consumer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
jQuery(document).on('turbolinks:load', function() {
  ...
  if (comments.length > 0) {
    App.global_chat = !(function webpackMissingModule() { var e = new Error("Cannot find module '../consumer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).subscriptions.create({
...
/******/ });
//# sourceMappingURL=blogs-5a87a0f2b99c8e0d440e.js.map
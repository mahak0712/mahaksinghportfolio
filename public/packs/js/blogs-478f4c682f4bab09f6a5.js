...
jQuery(document).on('turbolinks:load', function() {
  ...
  if (comments.length > 0) {
    !(function webpackMissingModule() { var e = new Error("Cannot find module '../channels/cable'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).subscriptions.create({
  ...
  return $('#new_comment').submit(function(e) {
    ...
    if ($.trim(textarea.val()).length > 1) {
      send_comment(textarea.val(), comments.data('blog-id'), textarea.val(''));
    }
    e.preventDefault();
    return false;
  });
...
/******/ });
//# sourceMappingURL=blogs-478f4c682f4bab09f6a5.js.map
...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module '/channels/consumer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
jQuery(document).on('turbolinks:load', function() {
  ...
  if (comments.length > 0) {
    App.global_chat = !(function webpackMissingModule() { var e = new Error("Cannot find module '/channels/consumer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).subscriptions.create({
...
/******/ });
//# sourceMappingURL=blogs-3f3a16a4853df732da38.js.map
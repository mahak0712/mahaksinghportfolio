...
/* WEBPACK VAR INJECTION */(function($) {console.log('Meher');
...
jQuery(document).on('turbolinks:load', function() {
  ...
  if (reviews.length > 0) {
    App.global_chat = App.cable.subscriptions.create({
      ...
      received: function(data) {
        return reviews.append(data['review']);
      },
      send_review: function(review, station_id) {
        return this.perform('send_review', {
          review: review,
  ...
  return $('#new_review').submit(function(e) {
    var $this, textarea;
    $this = $(this);
    textarea = $this.find('#review_content');
    if ($.trim(textarea.val()).length > 1) {
      App.global_chat.send_review(textarea.val(), reviews.data('station-id'));
      textarea.val('');
    }
    e.preventDefault();
    return false;
    return console.log('Singh');
  });
});
...
/******/ });
//# sourceMappingURL=blogs-4eb425068bb04d62b812.js.map